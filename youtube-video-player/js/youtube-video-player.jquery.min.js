 ...
 */
	...
	//options and customization on: https://rikdevos.com/demos/youtube-video-playlist/documentation.html
	var	api_key= 'AIzaSyCWCNPhlYh-T4ItG_lwhZL5zFP233Kyyj0';
	var	show_playlist= true;
	var	playlist_type= "horizontal";
	var	show_channel_in_playlist= false;
	var	show_channel_in_title= false;
	var	width= '790px';
	var	now_playing_text= "";
	var load_more_text= "Cargar más";
	var	hide_youtube_logo= true;
	var	controls_bg= 'rgba(44,62,80,.75)';
	var	buttons= 'rgba(255,255,255,.5)';
	var	buttons_hov_act= 'rgba(255,255,255,1)';
	var	buffer= 'rgba(255,255,255,.25)';
	var	fill= 'rgba(255,255,255,1)';
	var	video_title='rgba(0,0,0,0)';
	var	video_channel = '#DFF76D';
	var	playlist_overlay= 'rgba(44,62,80,0.5)';
	var	playlist_title= '#FFFFFF';
	var	scrollbar= 'rgb(220,20,20)';
	var	scrollbar_bg= 'rgba(255,255,255,.75)';
	
  $('#playlist-motiongraphics').youtube_video({
	playlist: 'PLNUSZQPMnxtBuHp-JgIEbTFUZCV9LxqPc',
	api_key: api_key,
	show_playlist: show_playlist,
	playlist_type: playlist_type,
	show_channel_in_playlist: show_channel_in_playlist,
	show_channel_in_title: show_channel_in_title,
	width: width,
	now_playing_text: now_playing_text,
	load_more_text: load_more_text,
	hide_youtube_logo: hide_youtube_logo,
	colors: {
		controls_bg:      controls_bg,
		buttons:          buttons,
		buttons_hover:    buttons_hov_act,
		buttons_active:   buttons_hov_act,
		time_text:        buttons_hov_act,
		bar_bg:           buttons,
		buffer:           buffer,
		fill:             fill,
		...
		playlist_channel: video_channel,
		scrollbar:        scrollbar,
		scrollbar_bg:     scrollbar_bg,}	  
	});
	
	
	$('#playlist-videolyrics').youtube_video({
		playlist: 'PLNUSZQPMnxtDuWN23kHL4au-jW0eF5Crz',
		api_key: api_key,
		show_playlist: show_playlist,
		playlist_type: playlist_type,
		show_channel_in_playlist: show_channel_in_playlist,
	...
	$('#playlist-videoclips').youtube_video({
		playlist: 'PLNUSZQPMnxtAcqTaFOq9kvKRXmww2sJYl',
		api_key: api_key,
		show_playlist: show_playlist,
		playlist_type: playlist_type,
		show_channel_in_playlist: show_channel_in_playlist,
	...
	$('#playlist-otros').youtube_video({
		playlist: 'PLNUSZQPMnxtBpLl5amA9fHtLyD1u1-ys6',
		api_key: api_key,
		show_playlist: show_playlist,
		playlist_type: playlist_type,
		show_channel_in_playlist: show_channel_in_playlist,
